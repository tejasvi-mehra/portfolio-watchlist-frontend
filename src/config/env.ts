...
// Fallback keeps the app visible while still allowing feed connection attempts.
const resolvedWsUrl = wsUrl && wsUrl.trim() !== "" ? wsUrl : "ws://localhost:8080/ws";
...
export const env = {
  appName: (import.meta.env.VITE_APP_NAME as string | undefined) || "Portfolio Watchlist",
  wsUrl: resolvedWsUrl,
